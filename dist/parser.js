...
/***/ function(module, exports, __webpack_require__) {
	...
	var _asyncFetchJs = __webpack_require__(95);

	var _asyncFetchJs2 = _interopRequireDefault(_asyncFetchJs);

	var PostsFetcher = (function () {
	  function PostsFetcher() {
	    _classCallCheck(this, PostsFetcher);
	  }

	  _createClass(PostsFetcher, [{
	    key: 'constuctor',
	    value: function constuctor() {
	      var count = arguments[0] === undefined ? 10 : arguments[0];
	      ...
	      this.getUrl = function (count) {
	        return 'https://api.vk.com/method/wall.get?domain=apartments_ekb&count=' + this.count + '&offset=' + this.offset;
	      };
	    }
	  }, {
	    key: 'fetchNext',
	    value: function fetchNext() {
	      var posts;
	      return regeneratorRuntime.async(function fetchNext$(context$2$0) {
	        while (1) switch (context$2$0.prev = context$2$0.next) {
	          case 0:
	            context$2$0.next = 2;
	            return regeneratorRuntime.awrap((0, _asyncFetchJs2['default'])(this.getUrl(10)));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _thenJsonp = __webpack_require__(96);

	var _thenJsonp2 = _interopRequireDefault(_thenJsonp);

	exports['default'] = function (url) {
	  console.info('Fetching new data from ' + url + '...');

	  return (0, _thenJsonp2['default'])('GET', url).then(function (data) {
	    console.log('... data from ' + url + ' fetched!', data);
	  })['catch'](function (error) {
	    console.error('... fetching from ' + url + ' failed!', error);
	  });
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(94), __webpack_require__(100).setImmediate))
